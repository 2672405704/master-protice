...
- (void)viewDidLoad {
    ...
    //从相册选取二维码
    UIButton *bnt = [[UIButton alloc]initWithFrame:mRect(0, 0, 50, 40)];
    [bnt setTitle:@"相册" forState:UIControlStateNormal];
    [bnt setTitleColor:MainFontColor forState:UIControlStateNormal];
    [bnt.titleLabel setFont:UIFONT(15)];
    [bnt addTarget:self action:@selector(readerImage) forControlEvents:UIControlEventTouchUpInside];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:bnt];
}
