...
#define gkey    @"abcdefgh12345678" //自行修改
#define gIv @"cfbsdfgsdfxccvd1" //自行修改
...
//+ (NSString *) udid
//{
//    return[Utility AES128Encrypt:[[UIDevice currentDevice] uniqueIdentifier]];
//}
...
{
    NSString *key = [Utility AESKey:str];
    return[Utility doCipher:str key:key context:kCCEncrypt];
}

+ (NSString *) encryptStr:(NSString *) str andKey:(NSString *)key
{
    NSString *keyEncrypt = [Utility AESKey:key];
//    NSString *keyEncrypt = key;
    return[Utility doCipher:str key:keyEncrypt context:kCCEncrypt];
}
...
{
    NSString *aesKey = @"";
    NSString *md5Str = [Utility md5:str];
    if (md5Str.length>9) {
        aesKey = [md5Str substringWithRange:NSMakeRange(1, 8)];
    }
    return aesKey;
}
...
//    NSString *key = [Utility AESKey:[CURRENTUSERID length]?CURRENTUSERID:@""];
////    NSString *key = @"abcdefgh12345678";
//    NSString *iv = @"abc123defg567h8i";
//    NSData *en_data = [plainTextData AES128EncryptWithKey:key iv:iv];
//    return [en_data base64EncodedString];
//}
...
+ (NSString *)encodeBase64WithData:(NSData *)objData {
    ...
    *objPointer = '\0';
    ...
    NSString *returnStr = [NSString stringWithCString:strResult encoding:NSASCIIStringEncoding];
...
+ (BOOL)isValidPhoneNumber:(NSString *)phoneNumber{
    ...
    NSString *num = @"^(((13[0-9])|(14[5,7])|(17[0|5-8])|(15([0-3]|[5-9]))|(18([0-9])))\\d{8})|(0\\d{2}-\\d{8})|(0\\d{3}-\\d{7})$";
